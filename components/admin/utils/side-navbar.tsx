...
export const SideNavBar = () => {
  return (
    <div className="w-60 h-full min-h-full flex flex-col gap-y-1 px-4 py-6 bg-white drop-shadow font-firs">
      <MenuItem link="/admin" title="Managers" icon={<RiAdminFill />} />
